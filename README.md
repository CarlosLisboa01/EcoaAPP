...
1. Abra a pasta do projeto no seu terminal (CMD).
2. Rode o comando `npm install` para baixar todas as dependências do projeto.
3. Em seguida, rode o comando `npm start` para iniciar o servidor do Expo.
4. Pegue o seu celular, abra o aplicativo **Expo Go** (Android/iOS) e escaneie o QR Code que vai aparecer na tela do terminal. O aplicativo irá carregar na mesma hora!
